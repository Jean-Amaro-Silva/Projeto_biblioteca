        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            indicator: UnderlineTabIndicator(
                borderSide: BorderSide(width: 2.0, color: Colors.white), // Cor e espessura da linha indicadora
              ),
          ),
        ),
        body: TabBarView(
                ...
                children: [
                  ...
                  Center(
                    child: ElevatedButton(
                        ...
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all<Color>(Colors.orange), // Cor de fundo do botão
